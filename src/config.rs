...
pub struct SystemConfig {
    ...
    #[serde(default)]
    pub wwwroot_dir: Option<PathBuf>,
...
const fn default_enable_swagger() -> bool {
    true
}
...
pub struct NetworkConfig {
    ...
    /// Matrix domain for bot Matrix protocol (e.g., "zimu.pub")
    /// If not specified, uses the first domain from the `domain` list
    #[serde(default)]
