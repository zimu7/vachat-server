...
mod tests {
    ...
    async fn test_upload_file_and_send_subscribe_msg() {
        ...
        detail.get("content_type").assert_string("vachat/file");
    ...
    async fn test_archive() {
        ...
        user.get("name").assert_string("user1@zimu.pub");
        ...
        msg.get("from_user").assert_i64(0);
        msg.get("content_type").assert_string("vachat/file");
